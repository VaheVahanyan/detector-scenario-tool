...
class EraseFlashPayloadEditor(PayloadEditorBase):
    ...
    def retranslate_ui(self) -> None:
        self.label_bank.setText(tr("payload.erase_flash.bank"))
        self.label_keep_power.setText(tr("payload.erase_flash.keep_power"))
    ...
    def set_payload(self, payload: dict) -> None:
        ...
        self.keep_power_checkbox.setChecked(bool(payload.get("keep_power_after_erase", False)))

        self._building = False

    def write_payload(self, payload: dict) -> None:
        payload["selected_nand_bank"] = self.bank_combo.currentData()
        payload["keep_power_after_erase"] = self.keep_power_checkbox.isChecked()
